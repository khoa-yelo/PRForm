#!/bin/bash
#SBATCH --job-name=species_kfold_train
#SBATCH --output=logs/train_species_kfold_%A_%a.out
#SBATCH --error=logs/train_species_kfold_%A_%a.err
...
FOLD_DIR=/projects/m000151/khoa/repos/PRForm/training_data/species_random_kfold/fold_${SLURM_ARRAY_TASK_ID}
